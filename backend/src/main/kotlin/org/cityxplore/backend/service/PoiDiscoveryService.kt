...
import org.cityxplore.backend.mapper.toDto
import org.cityxplore.backend.mapper.toDtoList
...
class PoiDiscoveryService(
     ...
     * @throws ResponseStatusException if the POI does not exist or has already been discovered by the user.
     */
    @Transactional
